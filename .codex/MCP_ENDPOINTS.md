# IND_CRM_API MCP Endpoints (actualizado 2026-01-30)

Fuentes: `.codex/ENDPOINTS.md` + Postman V8 (`.codex/Postman/IND_CRM_API V8.postman_collection.json`).
...
- HTTP: GET `/api/crm/expensesheets/list`
- Auth: Bearer token
- Headers: `Authorization`, `X-IND-Company`, `X-IND-AxUserId`
- Query (requerido):
  - `filter` (string)
...
- Respuesta: `IndPagedResponse<ExpenseSheetDto>`
