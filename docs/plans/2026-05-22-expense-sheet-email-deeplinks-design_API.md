...
- Do not add the Microsoft Graph SDK in `IND_CRM_API`.
...
InternalMail:ClientId                      -> INDCRM_INTERNAL_API_CLIENT_ID
InternalMail:ClientSecret                  -> INDCRM_INTERNAL_API_CLIENT_SECRET
...
- `ExpenseNotifications:Enabled = false`
- `ExpenseNotifications:BestEffort = true`
- `ExpenseNotifications:NotifyTransitions = ExpenseSheetApprovalRequested,ExpenseSheetApproved`
