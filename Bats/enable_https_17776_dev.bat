...
title Habilitar HTTPS IND_CRM_API 17776 DEV
cd /d "%~dp0"

REM ------------------------------------------------------
REM Configure HTTP.sys for DEV HTTPS on port 17776.
REM
REM Guardrails:
...
REM   enable_https_17776_dev.bat "C:\custom\path\dominio.pfx"
REM   enable_https_17776_dev.bat "C:\custom\path\dominio.pfx" "password"
if not "%~1"=="" (
    set "PFX_PATH=%~1"
