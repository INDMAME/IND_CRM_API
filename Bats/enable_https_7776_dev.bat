...
title Habilitar HTTPS IND_CRM_API 7776 DEV
cd /d "%~dp0"
...
REM   enable_https_7776_dev.bat "C:\custom\path\dominio.pfx"
REM   enable_https_7776_dev.bat "C:\custom\path\dominio.pfx" "password"
if not "%~1"=="" (
    set "PFX_PATH=%~1"
