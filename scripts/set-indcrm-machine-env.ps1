...
$settings = @(
    ...
    New-EnvSetting -Name "INDCRM_ASSISTANT_QUERY_RATE_LIMIT_ENABLED" -Value "true" -Category "AssistantQueries"
    New-EnvSetting -Name "INDCRM_ASSISTANT_QUERY_RATE_LIMIT_MAX_REQUESTS" -Value "30" -Category "AssistantQueries"
    New-EnvSetting -Name "INDCRM_ASSISTANT_QUERY_RATE_LIMIT_WINDOW_SECONDS" -Value "900" -Category "AssistantQueries"
    New-EnvSetting -Name "INDCRM_ASSISTANT_QUERY_RATE_LIMIT_VALIDATION_MULTIPLIER" -Value "1" -Category "AssistantQueries"
