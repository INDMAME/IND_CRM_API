...
$settings = @(
    ...
    New-EnvSetting -Name "OPENAI_EXPENSE_TICKET_REASONING_EFFORT" -Value "minimal" -Category "OpenAI"
    ...
    New-EnvSetting -Name "OPENAI_EXPENSE_TICKET_QUICK_CREATE_REASONING_EFFORT" -Value "minimal" -Category "OpenAI"
